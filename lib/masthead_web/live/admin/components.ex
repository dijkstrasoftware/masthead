defmodule MastheadWeb.AdminLive.Components do
    ...
    <div id="admin-shell" class="admin-shell">
      ...
      <aside id="admin-sidebar" class="admin-sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <% else %>
            ...
            <div class="sidebar-external">
              <.external_link href="https://docs.masthead.site" label="Docs">
                <.icon_book />
              </.external_link>
              <.external_link href="https://blog.masthead.site" label="Blog">
                <.icon_newspaper />
              </.external_link>
              <.external_link href="https://discord.gg/M3Df9rNbC" label="Discord">
                <.icon_discord />
              </.external_link>
            </div>
          <% end %>
        ...
        <div :if={@current_user} class="sidebar-user">
          <.link
            navigate={~p"/account"}
            class={["sidebar-account", @active == :account && "active"]}
  ...
  * `allow_theme` — when true, shows a third "Theme page" card (pages only;
  ...
  defp icon_newspaper(assigns) do
    ~H"""
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
  ...
  @doc "Camera — the affordance for replacing a picture in place."
